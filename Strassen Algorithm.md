...
* 알고리즘 설명 & 코드 설명
  ...
  그리고 4등분을 하는 과정을 거치기 때문에 `2**n,2**n` 꼴이 아니면 그렇게 하도록 입력 값을 조정해서 행렬을 만들어 줍니다. 아래 코드가 이 설명의 코드 입니다.
  
  
  ![선언부](https://user-images.githubusercontent.com/80373000/116213502-d10ee980-a780-11eb-82c5-6227f60a5b4f.JPG)
